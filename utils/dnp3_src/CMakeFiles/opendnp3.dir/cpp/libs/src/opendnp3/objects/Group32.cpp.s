...
.LFB394:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group32Var1C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group32Var14ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L18
.L12:
...
.L21:
	...
	orr	w3, w3, w4
	strb	w3, [sp, 48]
	bl	_ZN8opendnp311Group32Var15WriteERKS0_RN7openpal6WSliceE
...
.LFB401:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group32Var2C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group32Var24ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L43
.L37:
...
.L46:
	...
	orr	w3, w3, w4
	strb	w3, [sp, 48]
	bl	_ZN8opendnp311Group32Var25WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 56]
	ldr	x2, [x1]
...
.LFB408:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group32Var3C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group32Var34ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L78
.L72:
...
.L81:
	...
	str	w2, [sp, 60]
	str	x5, [sp, 64]
	bl	_ZN8opendnp311Group32Var35WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 72]
	ldr	x2, [x1]
...
.LFB415:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group32Var4C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group32Var44ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L113
.L107:
...
.L116:
	...
	strh	w2, [sp, 58]
	str	x5, [sp, 64]
	bl	_ZN8opendnp311Group32Var45WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 72]
	ldr	x2, [x1]
...
.LFB422:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group32Var5C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group32Var54ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L138
.L132:
...
.L141:
	...
	orr	w2, w2, w3
	strb	w2, [sp, 48]
	bl	_ZN8opendnp311Group32Var55WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 56]
	ldr	x2, [x1]
...
.LFB429:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group32Var6C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group32Var64ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L163
.L157:
...
.LFB430:
	...
	strb	w2, [sp, 56]
	str	d0, [sp, 64]
	bl	_ZN8opendnp311Group32Var65WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 72]
	ldr	x2, [x1]
...
.LFB436:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group32Var7C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group32Var74ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L195
.L189:
...
.L198:
	...
	str	s0, [sp, 60]
	str	x4, [sp, 64]
	bl	_ZN8opendnp311Group32Var75WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 72]
	ldr	x2, [x1]
...
.LFB443:
	...
	str	x1, [sp, 104]
	mov	x1, 0
	bl	_ZN8opendnp311Group32Var8C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group32Var84ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L230
.L224:
...
.LFB444:
	...
	str	x2, [sp, 64]
	str	d0, [sp, 56]
	bl	_ZN8opendnp311Group32Var85WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 72]
	ldr	x2, [x1]
...
.LFE600:
	...
	.align	3
	.xword	_GLOBAL__sub_I_Group32.cpp
