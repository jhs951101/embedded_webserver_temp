...
.LFB394:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group23Var1C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group23Var14ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L18
.L12:
...
.LFB395:
	...
	strb	w3, [sp, 48]
	str	w2, [sp, 52]
	bl	_ZN8opendnp311Group23Var15WriteERKS0_RN7openpal6WSliceE
...
.LFB401:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group23Var2C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group23Var24ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L40
.L34:
...
.LFB402:
	...
	strb	w3, [sp, 48]
	strh	w2, [sp, 50]
	bl	_ZN8opendnp311Group23Var25WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 56]
	ldr	x2, [x1]
...
.LFB408:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group23Var5C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group23Var54ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L72
.L66:
...
.LFB409:
	...
	str	w3, [sp, 60]
	str	x2, [sp, 64]
	bl	_ZN8opendnp311Group23Var55WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 72]
	ldr	x2, [x1]
...
.LFB415:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group23Var6C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group23Var64ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L104
.L98:
...
.LFB416:
	...
	strh	w3, [sp, 58]
	str	x2, [sp, 64]
	bl	_ZN8opendnp311Group23Var65WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 72]
	ldr	x2, [x1]
