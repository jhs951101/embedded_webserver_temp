...
.LFB394:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp310Group2Var1C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp310Group2Var14ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L12
.L6:
...
.L12:
	...
	add	x20, sp, 64
	mov	x0, x20
	bl	_ZN8opendnp36BinaryC1ENS_5FlagsE
	ldrb	w0, [sp, 80]
	ldp	x2, x3, [sp, 64]
	stp	x2, x3, [x21]
	strb	w0, [x21, 16]
...
.LFB395:
	...
	mov	x0, x19
	strb	w2, [sp, 48]
	bl	_ZN8opendnp310Group2Var15WriteERKS0_RN7openpal6WSliceE
...
.LFB401:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp310Group2Var2C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp310Group2Var24ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L34
.L28:
...
.L34:
	...
	ldr	x2, [sp, 56]
	mov	x0, x20
	bl	_ZN8opendnp36BinaryC1ENS_5FlagsEN7openpal10UInt48TypeE
	ldrb	w0, [sp, 80]
	ldp	x2, x3, [sp, 64]
	stp	x2, x3, [x21]
	strb	w0, [x21, 16]
...
.LFB402:
	...
	strb	w3, [sp, 56]
	str	x2, [sp, 64]
	bl	_ZN8opendnp310Group2Var25WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 72]
	ldr	x2, [x1]
...
.LFB408:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp310Group2Var3C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp310Group2Var34ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L56
.L50:
...
.LFB409:
	...
	strb	w3, [sp, 48]
	strh	w2, [sp, 50]
	bl	_ZN8opendnp310Group2Var35WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 56]
	ldr	x2, [x1]
