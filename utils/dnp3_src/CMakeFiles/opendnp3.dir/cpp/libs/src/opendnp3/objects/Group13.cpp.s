...
.LFB394:
	...
	str	x1, [sp, 72]
	mov	x1, 0
	bl	_ZN8opendnp311Group13Var1C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group13Var14ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L12
.L6:
...
.L12:
	...
	ldrb	w1, [sp, 48]
	add	x0, sp, 56
	bl	_ZN8opendnp318BinaryCommandEventC1ENS_5FlagsE
	ldrh	w1, [sp, 56]
	ldr	x0, [sp, 64]
	strh	w1, [x21]
	str	x0, [x21, 8]
...
.LFB395:
	...
	bl	_ZN8opendnp311Group13Var1C1Ev
	mov	x0, x21
	bl	_ZNK8opendnp318BinaryCommandEvent8GetFlagsEv
	mov	w2, w0
	mov	x1, x20
	mov	x0, x19
	strb	w2, [sp, 48]
	bl	_ZN8opendnp311Group13Var15WriteERKS0_RN7openpal6WSliceE
...
.LFB401:
	...
	str	x1, [sp, 88]
	mov	x1, 0
	bl	_ZN8opendnp311Group13Var2C1Ev
	mov	x1, x19
	mov	x0, x20
	bl	_ZN8opendnp311Group13Var24ReadERN7openpal6RSliceERS0_
	mov	w19, w0
	tst	w0, 255
	bne	.L34
.L28:
...
.L34:
	...
	add	x0, sp, 72
	ldr	x2, [sp, 64]
	bl	_ZN8opendnp318BinaryCommandEventC1ENS_5FlagsEN7openpal10UInt48TypeE
	ldrh	w1, [sp, 72]
	ldr	x0, [sp, 80]
	strh	w1, [x21]
	str	x0, [x21, 8]
...
.LFB402:
	...
	strb	w3, [sp, 56]
	str	x2, [sp, 64]
	bl	_ZN8opendnp311Group13Var25WriteERKS0_RN7openpal6WSliceE
	adrp	x1, :got:__stack_chk_guard
	ldr	x1, [x1, #:got_lo12:__stack_chk_guard]
	ldr	x3, [sp, 72]
	ldr	x2, [x1]
